...
public class QuestaoIntegrationDTO {
	...
	private Set<RespostaEsperadaDTO> respostaEsperada;
	...
	public Set<RespostaEsperadaDTO> getRespostaEsperada() {
		return respostaEsperada;
	}

	public void setRespostaEsperada(Set<RespostaEsperadaDTO> respostaEsperada) {
